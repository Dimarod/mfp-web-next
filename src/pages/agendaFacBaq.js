  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const resNutricion = await axios.post(
        "/api/citasDermoBaq/validarNutricion",
        appoinment
      );
      ...
      const resAgendar = await axios.post("/api/citasDermoBaq/", appoinment);
