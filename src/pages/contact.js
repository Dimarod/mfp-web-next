          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-transparent text-brand-vanilla-dark rounded-[2rem] p-8 md:p-10 shadow-xl flex flex-col justify-between relative overflow-hidden group">
              ...
              <div>
                ...
                {/* Email */}
                <div>
                  <p className="text-xs text-brand-vanilla-dark font-sans uppercase tracking-widest mb-2">Correo Electrónico</p>
                  <a
                    href="mailto:myfootprintsas@gmail.com"
