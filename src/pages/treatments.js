...
const Treatments = () => {
  return (
    <>
    <Head>
      <title>Tratamientos Corporales - Dermocosméticos - Postoperatorio | My Footprint Barranquilla</title>
      <meta name="description" content="Descubre nuestros tratamientos estéticos y postquirúrgicos en Barranquilla. Drenaje linfático, moldeamiento y rejuvenecimiento facial con tecnología de vanguardia."/>
    </Head>
      <Layout>
